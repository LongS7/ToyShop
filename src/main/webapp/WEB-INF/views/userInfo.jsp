			...
			<%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
				<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
					...
					<head>
						...
						<link rel="stylesheet" href="${ context }/resources/fontawesome-free-5.15.3-web/css/all.css">
						<script>
								...
								<div class="row">
									<%@include file="/WEB-INF/views/sideNavigationBar.jsp" %>
										<div class="col-8">
											...
											<form:form method="POST" modelAttribute="user" class="border"
												style="padding: 20px;">
												<div class="form-group">
													<form:label class="font-weight-bold" path="account.username">Tên
												...
												<div class="custom-control custom-radio custom-control-inline">
													...
													<form:label path="gender" class="custom-control-label" for="male">
														Nam
													</form:label>
												</div>
												<div class="custom-control custom-radio custom-control-inline">
													...
													<form:label path="gender" class="custom-control-label" for="female">
														Nữ
													</form:label>
												</div>
												<div class="form-group">
												...
												<form:input path="account.password" value="${user.account.password }"
													type="hidden" />

				...
				<a class="dropdown-item d-flex align-items-center" href="#">
					<div class="dropdown-list-image mr-3">
						<img class="rounded-circle"
							src="${ context }/resources/images/undraw_profile_1.svg" alt="">
					...
					<div class="dropdown-list-image mr-3">
						<img class="rounded-circle"
							src="${ context }/resources/images/undraw_profile_2.svg" alt="">
					...
					<div class="dropdown-list-image mr-3">
						<img class="rounded-circle"
							src="${ context }/resources/images/undraw_profile_3.svg" alt="">
		...
		<li class="nav-item dropdown no-arrow"><a
			...
			<div
				...
				<a class="dropdown-item" href="#"> <i
					...
					class="fas fa-list fa-sm fa-fw mr-2 text-gray-400"></i> Lịch sử hoạt động
				</a>

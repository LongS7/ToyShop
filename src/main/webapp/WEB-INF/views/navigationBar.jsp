	...
	<div class="collapse navbar-collapse justify-content-center"
		...
		<ul class="navbar-nav">
			<li class="nav-item"><a class="nav-link"
				href="${ pageContext.request.contextPath }/san-pham/tat-ca?page=1&limit=20"">Sản
					phẩm</a></li>
						...
						<c:forEach var="map" items="${ categories }">
							<div class="dropdown-item">
								<div class="dropdown dropright">
									<a class="btn" href="${ context }/danh-muc?des=${ map.key }"
										data-toggle="dropdown">${ map.key }</a>
									<div class="dropdown-menu">
										<c:forEach var="cate" items="${ map.value }">
											<a class="dropdown-item"
												href="${ pageContext.request.contextPath }/danh-muc/${ cate._id }?page=1&limit=20">${ cate.categoryName }</a>
										</c:forEach>
									</div>
								</div>
							</div>
			...
			<li class="nav-item dropdown"><a class="nav-link"
				...
				<div class="dropdown-menu ">
					<a class="dropdown-item"
						href="${ pageContext.request.contextPath }/san-pham/?tuoi=1-3-tuoi&page=1&limit=20">1
						- 3 tuổi</a> <a class="dropdown-item"
						href="${ pageContext.request.contextPath }/san-pham/?tuoi=4-6-tuoi&page=1&limit=20">4
						- 6 tuổi</a> <a class="dropdown-item"
						href="${ pageContext.request.contextPath }/san-pham/?tuoi=6-11-tuoi&page=1&limit=20">6
						- 11 tuổi</a> <a class="dropdown-item"
						href="${ pageContext.request.contextPath }/san-pham/?tuoi=12-tuoi-tro-len&page=1&limit=20">12
						tuổi trở lên</a>
				</div></li>

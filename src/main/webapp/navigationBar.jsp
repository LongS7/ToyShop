...
<nav class="navbar navbar-expand-md bg-light navbar-light">
    ...
    <div class="collapse navbar-collapse" id="collapsibleNavbar">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item active"><a class="nav-link" href="#"><i class="fas fa-user-alt"></i> Tài khoản </a></li>
        </ul>
    </div>
</nav>
    ...
    <div class="collapse navbar-collapse justify-content-center" id="collapsibleNavbar">
        <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#">Độ tuổi</a>
                <div class="dropdown-menu">
                  <a class="dropdown-item" href="#">0 - 12 tuổi</a>
                  <a class="dropdown-item" href="#">1 - 3 tuổi</a>
                  <a class="dropdown-item" href="#">3 - 6 tuổi</a>
                </div>
            </li>
